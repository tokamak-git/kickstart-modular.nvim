local cc = {
      ...
      adapters = {
        anthropic = function()
          return require('codecompanion.adapters').extend('anthropic', {
            env = {
              api_key = 'cmd:pass anthropic/api',
            },
          })
        end,
        ...
        openai = function()
          return require('codecompanion.adapters').extend('openai', {
            env = {
              proxy = 'https://api.groq.com/openai/v1',
              api_key = 'cmd:pass groq/apikey',
            },
          })
        end,
        llama3 = function()
  ...
  -- config = function()
  --   -- default config
  --   require('codecompanion').setup {kk
  --     adapters = {
  --       anthropic = require('codecompanion.adapters').use 'ollama',
  --       ollama = require('codecompanion.adapters').use 'ollama',
  --       openai = require('codecompanion.adapters').use 'ollama',
  --     },
  --     strategies = {
  --       chat = 'ollama',
  --       inline = 'ollama',
